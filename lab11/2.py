...
#executing
cur.execute("""CALL insert_to_pb('shimpanzini','bananini',465465654);
""")
cur.execute("""CALL insert_to_pb('bombardiro','crocadilo',8989898);
""")
cur.execute("""CALL insert_to_pb('fromp','tosql',564456);
""")
cur.execute("""SELECT *
