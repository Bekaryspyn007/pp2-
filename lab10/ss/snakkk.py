...
connection=pgsql.connect(host="localhost", dbname="mybase", user="postgres",
...
bg=pg.image.load("lab10/ss/bg.png").convert_alpha()
bgdead=pg.image.load("lab10/ss/bgdead.png").convert_alpha()
icon=pg.image.load("lab10/ss/icon.png").convert_alpha()
pg.display.set_icon(icon)
game_font = pg.font.Font('lab10/ss/Minecraft.ttf', 25)
...
class SNAKE:
    def __init__(self):
        ...
        self.head_up = pg.image.load('lab10/ss/head_up.png').convert_alpha()
        self.head_down = pg.image.load('lab10/ss/head_down.png').convert_alpha()
        self.head_right = pg.image.load('lab10/ss/head_right.png').convert_alpha()
        self.head_left = pg.image.load('lab10/ss/head_left.png').convert_alpha()
		
        self.tail_up = pg.image.load('lab10/ss/tail_up.png').convert_alpha()
        self.tail_down = pg.image.load('lab10/ss/tail_down.png').convert_alpha()
        self.tail_right = pg.image.load('lab10/ss/tail_right.png').convert_alpha()
        self.tail_left = pg.image.load('lab10/ss/tail_left.png').convert_alpha()

        self.body_vertical = pg.image.load('lab10/ss/body_vertical.png').convert_alpha()
        self.body_horizontal = pg.image.load('lab10/ss/body_horizontal.png').convert_alpha()

        self.body_tr = pg.image.load('lab10/ss/body_tr.png').convert_alpha()
        self.body_tl = pg.image.load('lab10/ss/body_tl.png').convert_alpha()
        self.body_br = pg.image.load('lab10/ss/body_br.png').convert_alpha()
        self.body_bl = pg.image.load('lab10/ss/body_bl.png').convert_alpha()
        self.crunch_sound = pg.mixer.Sound('lab10/ss/se_fruit.mp3')
...
class MAIN:
    def __init__(self):
        ...
        self.fruit=FRUIT()
        self.dead=False
        self.dead_sound = pg.mixer.Sound('lab10/ss/se_dead.mp3')
